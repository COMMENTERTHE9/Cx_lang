...
- [x] CR#1–4: range-check literals through generic type args, array elements in struct fields/call args, return values, if/when branch tails; unified all width checking through single semantic-level function (b8e92fb..cbba042)
