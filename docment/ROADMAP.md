...
- [x] Gate-1a/1b0/1b/2a/2b — JIT arithmetic safety (INT_MIN/-1 guard, div-zero trap, clean host-exit, width-narrowing, array bounds-check)
...
**2026-06-20:** No new code commits. Matrix 230/0 on main, steady. Submain still 16 commits ahead of main. Roadmap updated to reflect confirmed submain work (CR#1-4, Gate-1a–2b, `when` block lowering, parity 205/81/0). DotAccess in compound forms remains the last open Phase 11 sub-item.
