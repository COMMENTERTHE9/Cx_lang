...
**2026-08-02:** Four interlocking pieces on submain: gene-bound soundness fix (`e105e56`), generic-function monomorphization (`959a980`, new `monomorphize.rs` module), interpreter call-depth guard (`878ba7c`), JIT call-depth guard (`664850d`). Crash-instead-of-rejection pattern closed. Cycle-only guard optimization (`ab62a6d`) refined to zero overhead for non-recursive code via Tarjan's SCC. Also: const lowering (#12), exit lowering (#11), enforcement-layer fixes. Submain 26 commits ahead of main. Matrix on main: 380/0.

**2026-08-08:** No development activity since Aug 2. Submain remains 26 commits ahead of main, unmerged and untagged. Matrix on main: 380/0, unchanged. 13 daily-log PRs (#357–#366+) remain open. Merge to main remains the top outstanding task.
